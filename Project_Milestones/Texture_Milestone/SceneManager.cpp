...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("ambientLight", glm::vec3(0.3f, 0.3f, 0.3f)); // Bright global light
	...
	// Spotlight to focus on the center of the scene
	m_pShaderManager->setVec3Value("spotLight.position", glm::vec3(1.2f, 3.0f, 0.0f)); // Above the scene
	m_pShaderManager->setVec3Value("spotLight.direction", glm::vec3(-1.2f, -3.0f, 0.0f)); // Pointing down
	m_pShaderManager->setVec3Value("spotLight.ambient", glm::vec3(0.0f, 0.0f, 0.0f));
	m_pShaderManager->setVec3Value("spotLight.diffuse", glm::vec3(1.0f, 1.0f, 1.0f));
	...
	m_pShaderManager->setFloatValue("spotLight.linear", 0.14f);
	m_pShaderManager->setFloatValue("spotLight.quadratic", 0.07f);
	m_pShaderManager->setBoolValue("spotLight.bActive", true);

	// Point light to brighten a specific area
	...
	m_pShaderManager->setVec3Value("pointLights[0].diffuse", glm::vec3(0.9f, 0.9f, 0.9f));
	...
	m_pShaderManager->setFloatValue("pointLights[0].linear", 0.045f); // Slower falloff
...
void SceneManager::LoadSceneTextures()
{
	...
	bool bReturn = false;
	bReturn = CreateGLTexture("textures/matteblack.jpg", "mugbase");
	bReturn = CreateGLTexture("textures/teachflag.jpg", "flag");
	bReturn = CreateGLTexture("textures/wood.jpg", "table");
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.2f, 0.0f, 0.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.5f, 1.4f, 0.0f);
